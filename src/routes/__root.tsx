...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Muhammad Zharfan | Network Engineer" },
      {
        name: "description",
        content:
      ...
      { name: "author", content: "Muhammad Zharfan Tashbir Thariqi" },
      { property: "og:title", content: "Muhammad Zharfan | Network Engineer" },
      {
